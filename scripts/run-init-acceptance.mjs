...
if (JSON.stringify(commandNames) !== JSON.stringify(["reset", "spec-it-out", "plan"]) || extension.commands.has("clear")) throw new Error("initialized extension command contract failed");
...
const expectedCatalog = [{ name: "reset", source: "extension" }, { name: "spec-it-out", source: "extension" }, { name: "plan", source: "extension" }];
