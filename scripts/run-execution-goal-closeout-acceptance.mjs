...
let publicExtensionContext = null, terminalGoalCompletion = null;
const observer = (pi) => {
...
const { session } = await createAgentSession({
  ...
  tools: ["ipython", "ralph_lifecycle"], includeGoals: true, includeCompactSkill: false, thinkingLevel: "off",
});
const sessionEvents = [];
