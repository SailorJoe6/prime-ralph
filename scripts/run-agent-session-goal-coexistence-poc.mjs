...
const result = { cwd, calls, trace, entries: entries.map((e) => ({ type: e.type, customType: e.customType, summary: e.summary, firstKeptEntryId: e.firstKeptEntryId })), compactionApplied: Boolean(compaction), postCompactionGoalContext: postCompactionGoal, automaticContinuationDetected: calls > 2 };
if (!compaction || !postCompactionGoal || !result.automaticContinuationDetected) {
