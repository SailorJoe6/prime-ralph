...
1. **[Release contract](release-contract.md)** — what the package guarantees, what it leaves to the host, and how to validate a release.
2. **[Research slice 2](research-slice-2.md)** — why the lifecycle design has explicit boundaries and continuation rules.
3. **[Native transport acceptance](native-transport-acceptance.md)** — how protocol checks were run and what they do, and do not, prove.
